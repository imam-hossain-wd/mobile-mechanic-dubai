  ...
  return (
    <section className="relative bg-white py-16 md:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-20">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div className="relative border border-gray-200 bg-gray-50">
              <Image
                src={images?.whoweare}
                alt="Car Repair Mobile Mechanic Dubai team at Trade Center"
                width={600}
                height={700}
                className="w-full h-[400px] md:h-[500px] lg:h-[580px] object-cover"
                priority
            ...
            <div className="absolute -bottom-6 -left-6 hidden md:block">
              <div className="bg-white border border-gray-200 p-5 shadow-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-400 uppercase tracking-wider">Headquarters</p>
                    <p className="text-sm font-semibold text-gray-900">Trade Center, Dubai</p>
                    <p className="text-xs text-gray-500 mt-1">Sheikh Zayed Road</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div className="space-y-4 text-gray-600">
              <p className="text-base leading-relaxed">
                Car Repair Mobile Mechanic Dubai stands as a trusted name in the UAE’s automotive service industry. Based at 99 Sheikh Zayed Road, we have redefined mobile car repair by delivering fast, reliable, and high-quality vehicle maintenance services across Dubai.
              </p>
              <p className="text-base leading-relaxed">
                Our certified technicians bring the workshop directly to your location—whether you are stranded near DIFC, parked at home in Business Bay, or at your office in the Trade Center. We specialize in providing convenient on-site car repair solutions designed to save you time and eliminate the stress of visiting a traditional garage.
              </p>
              <p className="text-base leading-relaxed">
                From emergency car battery replacement and jump start services to advanced engine diagnostics, car AC repair, and brake services, our team is equipped with modern tools and expertise. With 24/7 roadside assistance, help is always just a call away.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {[
                  "Trade Center", "DIFC", "Business Bay", "Zaa'beel",
                  "Al Kifaf", "Al Bada'a", "Meydan", "Pearl Jumeirah"
                ].map((area, index) => (
                  <div key={index} className="border border-gray-200 px-3 py-2 text-center">
                    <span className="text-xs text-gray-600">{area}</span>
                  </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
              ...
              <Button
                ...
                className="border-[#007A55] text-[#007A55] hover:bg-[#007A55]/5 h-14 px-8 text-sm font-medium tracking-wider rounded-none flex-1"
              >
                <a href="https://maps.google.com/?cid=9078533171483511712" target="_blank" rel="noopener noreferrer">
                  <MapPin className="mr-2 h-4 w-4" />
                  Trade Center, Dubai
                  <ChevronRight className="ml-2 h-4 w-4" />
                </a>
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 text-center">
          <p className="text-xs text-gray-400 tracking-wider">
            DUBAI'S PREMIER MOBILE MECHANIC • ESTABLISHED 2009 • TRADE CENTER HEADQUARTERS
          </p>
        </div>
      </div>
    </section>
